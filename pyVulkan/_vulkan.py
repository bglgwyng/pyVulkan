...
def VkPipelineRasterizationStateRasterizationOrderAMD(sType = VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_RASTERIZATION_ORDER_AMD, pNext = None, rasterizationOrder = None, ):
	return _newStruct('VkPipelineRasterizationStateRasterizationOrderAMD', sType = sType, pNext = pNext, rasterizationOrder = rasterizationOrder, )
...
def VkDebugMarkerObjectNameInfoEXT(sType = VK_STRUCTURE_TYPE_DEBUG_MARKER_OBJECT_NAME_INFO_EXT, pNext = None, objectType = None, object = None, pObjectName = None, ):
	return _newStruct('VkDebugMarkerObjectNameInfoEXT', sType = sType, pNext = pNext, objectType = objectType, object = object, pObjectName = pObjectName, )
...
def VkDebugMarkerObjectTagInfoEXT(sType = VK_STRUCTURE_TYPE_DEBUG_MARKER_OBJECT_TAG_INFO_EXT, pNext = None, objectType = None, object = None, tagName = None, tagSize = None, pTag = None, ):
	return _newStruct('VkDebugMarkerObjectTagInfoEXT', sType = sType, pNext = pNext, objectType = objectType, object = object, tagName = tagName, tagSize = tagSize, pTag = pTag, )
...
def VkDebugMarkerMarkerInfoEXT(sType = VK_STRUCTURE_TYPE_DEBUG_MARKER_MARKER_INFO_EXT, pNext = None, pMarkerName = None, color = None, ):
	return _newStruct('VkDebugMarkerMarkerInfoEXT', sType = sType, pNext = pNext, pMarkerName = pMarkerName, color = color, )
...
def VkDedicatedAllocationImageCreateInfoNV(sType = VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_IMAGE_CREATE_INFO_NV, pNext = None, dedicatedAllocation = None, ):
	return _newStruct('VkDedicatedAllocationImageCreateInfoNV', sType = sType, pNext = pNext, dedicatedAllocation = dedicatedAllocation, )
...
def VkDedicatedAllocationBufferCreateInfoNV(sType = VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_BUFFER_CREATE_INFO_NV, pNext = None, dedicatedAllocation = None, ):
	return _newStruct('VkDedicatedAllocationBufferCreateInfoNV', sType = sType, pNext = pNext, dedicatedAllocation = dedicatedAllocation, )
...
def VkDedicatedAllocationMemoryAllocateInfoNV(sType = VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_MEMORY_ALLOCATE_INFO_NV, pNext = None, image = None, buffer = None, ):
	return _newStruct('VkDedicatedAllocationMemoryAllocateInfoNV', sType = sType, pNext = pNext, image = image, buffer = buffer, )
...
def VkExternalImageFormatPropertiesNV(imageFormatProperties = None, externalMemoryFeatures = None, exportFromImportedHandleTypes = None, compatibleHandleTypes = None, ):
	return _newStruct('VkExternalImageFormatPropertiesNV', imageFormatProperties = imageFormatProperties, externalMemoryFeatures = externalMemoryFeatures, exportFromImportedHandleTypes = exportFromImportedHandleTypes, compatibleHandleTypes = compatibleHandleTypes, )
...
def VkExternalMemoryImageCreateInfoNV(sType = VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_NV, pNext = None, handleTypes = None, ):
	return _newStruct('VkExternalMemoryImageCreateInfoNV', sType = sType, pNext = pNext, handleTypes = handleTypes, )

def VkExportMemoryAllocateInfoNV(sType = VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO_NV, pNext = None, handleTypes = None, ):
	return _newStruct('VkExportMemoryAllocateInfoNV', sType = sType, pNext = pNext, handleTypes = handleTypes, )
...
def VkValidationFlagsEXT(sType = VK_STRUCTURE_TYPE_VALIDATION_FLAGS_EXT, pNext = None, disabledValidationCheckCount = None, pDisabledValidationChecks = None, ):
	return _newStruct('VkValidationFlagsEXT', sType = sType, pNext = pNext, disabledValidationCheckCount = disabledValidationCheckCount, pDisabledValidationChecks = pDisabledValidationChecks, )
...
class VkSuccessException(VkException):
	pass
...
def _raiseException(ret):
	exceptions = {
			...
			VK_ERROR_FRAGMENTED_POOL:VkFragmentedPoolError,
...
def _vkDestroySurfaceKHRWrapper(fn):
...
def _vkGetPhysicalDeviceSurfaceSupportKHRWrapper(fn):
...
def _vkGetPhysicalDeviceSurfaceCapabilitiesKHRWrapper(fn):
...
def _vkGetPhysicalDeviceSurfaceFormatsKHRWrapper(fn):
...
def _vkGetPhysicalDeviceSurfacePresentModesKHRWrapper(fn):
...
def _vkCreateSwapchainKHRWrapper(fn):
...
def _vkDestroySwapchainKHRWrapper(fn):
...
def _vkGetSwapchainImagesKHRWrapper(fn):
...
def _vkAcquireNextImageKHRWrapper(fn):
...
def _vkQueuePresentKHRWrapper(fn):
...
def _vkGetPhysicalDeviceDisplayPropertiesKHRWrapper(fn):
...
def _vkGetPhysicalDeviceDisplayPlanePropertiesKHRWrapper(fn):
...
def _vkGetDisplayPlaneSupportedDisplaysKHRWrapper(fn):
...
def _vkGetDisplayModePropertiesKHRWrapper(fn):
...
def _vkCreateDisplayModeKHRWrapper(fn):
...
def _vkGetDisplayPlaneCapabilitiesKHRWrapper(fn):
...
def _vkCreateDisplayPlaneSurfaceKHRWrapper(fn):
...
def _vkCreateSharedSwapchainsKHRWrapper(fn):
...
def _vkCreateDebugReportCallbackEXTWrapper(fn):
...
def _vkDestroyDebugReportCallbackEXTWrapper(fn):
...
def _vkDebugReportMessageEXTWrapper(fn):
...
def _vkDebugMarkerSetObjectTagEXTWrapper(fn):
...
def _vkDebugMarkerSetObjectNameEXTWrapper(fn):
...
def _vkCmdDebugMarkerBeginEXTWrapper(fn):
...
def _vkCmdDebugMarkerEndEXTWrapper(fn):
...
def _vkCmdDebugMarkerInsertEXTWrapper(fn):
...
def _vkCmdDrawIndirectCountAMDWrapper(fn):
...
def _vkCmdDrawIndexedIndirectCountAMDWrapper(fn):
...
def _vkGetPhysicalDeviceExternalImageFormatPropertiesNVWrapper(fn):
...
def _vkCreateXlibSurfaceKHRWrapper(fn):
...
def _vkGetPhysicalDeviceXlibPresentationSupportKHRWrapper(fn):
...
def _vkCreateXcbSurfaceKHRWrapper(fn):
...
def _vkGetPhysicalDeviceXcbPresentationSupportKHRWrapper(fn):
...
def _vkCreateWaylandSurfaceKHRWrapper(fn):
...
def _vkGetPhysicalDeviceWaylandPresentationSupportKHRWrapper(fn):
...
def _vkCreateMirSurfaceKHRWrapper(fn):
...
def _vkGetPhysicalDeviceMirPresentationSupportKHRWrapper(fn):
...
def _vkCreateAndroidSurfaceKHRWrapper(fn):
...
def _vkCreateWin32SurfaceKHRWrapper(fn):
...
def _vkGetPhysicalDeviceWin32PresentationSupportKHRWrapper(fn):
